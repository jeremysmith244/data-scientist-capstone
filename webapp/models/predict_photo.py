...
from models.extract_bottleneck_features import extract_VGG19
...
VGG19_model.load_weights('models/saved_models/weights.best.VGG19.hdf5')

# Load the dictionary of category names
with open ('models/saved_models/dog_names', 'rb') as fp:
